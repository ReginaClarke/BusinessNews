...
const US_LEADERSHIP_BASE_URL = `${BASE_URL}leadership&pageSize=60&sortBy=publishedAt&apiKey=`;

const US_RAISING_MONEY_BASE_URL = `${BASE_URL}raising-money&pageSize=60&sortBy=publishedAt&apiKey=`;

const US_SMALL_BUSINESS_BASE_URL = `${BASE_URL}small-business&pageSize=60&sortBy=publishedAt&apiKey=`;

const US_LIFESTYLE_BASE_URL = `${BASE_URL}lifestyle&pageSize=60&sortBy=publishedAt&apiKey=`;
